...
Future<List<BlocProvider>> di() async {
  ...
  return [
    ...
    // add_tikon
    BlocProvider<AddTikonBloc>(
        create: (context) => AddTikonBloc(addTikonUseCase: addTikonUseCase)),

    // detail_tikon
    BlocProvider<DetailTikonBloc>(
      create: (context) => DetailTikonBloc(deleteTikonUseCase: deleteTikonUseCase),
    ),
  ];
}
